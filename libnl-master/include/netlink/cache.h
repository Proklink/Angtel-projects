...
#define NL_CACHE_ELEMENTS(cache, obj)    \
	obj = nl_cache_get_first(cache); \
	obj != NULL;                     \
	obj = nl_cache_get_next(obj)

#define NL_CACHE_ELEMENTS_SAFE(cache, obj, next_obj)                        \
	obj = nl_cache_get_first(cache), next_obj = nl_cache_get_next(obj); \
	obj != NULL;                                                        \
	obj = next_obj, next_obj = nl_cache_get_next(next_obj)
