...
//created by daniil
struct hsr_node;
void hnode_put(struct hsr_node *);
#define _nl_auto_hsr_node _nl_auto(_nl_auto_hnode_fcn)
_NL_AUTO_DEFINE_FCN_TYPED0(struct hsr_node *, _nl_auto_hnode_fcn, hnode_put)
